...
export function ZennoteLogo({ size }: IconProps) {
   return (
...
export function ZennoteRawLogo({ size }: IconProps) {
   return (
      <svg xmlns="http://www.w3.org/2000/svg" width={Math.round(size * (501/493))} height={size} viewBox="0 0 501 493" fill="none">
